...
class ViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let marqueeAttribute = MarqueeAttribute(scrollDirection: .up, marqueeStyle: .normal, timeInterval: 0.5, imageViewWidth: 40, imageViewHeight: 70, contentWidth: Double(UIScreen.main.bounds.width-40), contentHeight: 70)
